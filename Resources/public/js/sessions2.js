/**
 * Created by Germen-laptop on 20-4-2017.
 */
/**
    ...
    var modules = {
        ...
        ipinfodb_location: function(api_key){
            return function (callback){
                ...
                util.embed_script("http://api.ipinfodb.com/v3/ip-city/?key=" + "7c656ca21f5263955a8258545e2ea0a192870617ef40518e29225b3a989cf5c2" + "&format=json&callback=ipinfocb");
            }}
    };
    ...
    var util = {
        ...
        set_cookie: function(cname, value, expires, options){ // from jquery.cookie.js
            ...
            return (document.cookie = [
                ...
                options.expires ? '; expires=' + new Date(options.expires).toUTCString() : '', // use expires attribute, max-age is not supported by Internet Explorer.
